...
ActiveRecord::Schema.define(version: 20161120181817) do
  ...
  create_table "endorsements", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.integer  "user_id"
    t.index ["picture_id"], name: "index_endorsements_on_picture_id", using: :btree
  ...
  add_foreign_key "endorsements", "pictures"
