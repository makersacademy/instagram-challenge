...
feature 'Deleting posts' do
  background do
    user = create(:user)
    user2 = user2 = create(:user, username: "Dave", email: 'as@email.com', password: "123456", password_confirmation: "123456", id: 2)
  ...
  scenario 'delete a comment they\'ve added to a post', js: true do
