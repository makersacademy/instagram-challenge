feature 'User can sign up' do
  scenario 'User enters unique username, email and a password and is signed up' do
    visit '/users/new'
  ...
  scenario 'User enters invalid sign up details and is redirected to index' do
    visit '/users/new'
    fill_in 'user_username', with: 'Andy'
