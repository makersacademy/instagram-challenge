...
# RSpec.describe PostsController, type: :controller do
  ...
  # let(:valid_attributes) { {description: "My image", image: upload_helper} }

  # let(:invalid_attributes) { {description: false, image: nil} }
  ...
  #   context "with valid params" do
  #     let(:new_attributes) {
  #       { description: "My image", image: upload_helper}
  #     }
  ...
  #       post.reload
  #       { description: "My image updated", image: upload_helper}
  #     end
