...
class Post {
  ...
  static async addPost(text, user_id) {
    ...
    return { id: newPost.rows[0].id, message: newPost.rows[0].text, userID: newPost.rows[0].user_id };
  }
  ...
  static async getPostById(id) {
    ...
    return { id: post.rows[0].id, message: post.rows[0].text, userID: post.rows[0].user_id };
  }
}
